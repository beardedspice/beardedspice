...
{
    NSDictionary *info = [tab executeJavascript:@"(function(){var song=document.querySelector('#currentSong'); return {'artist': song.querySelector('.artist_name').innerText, 'track': song.querySelector('.song-details').innerText}})()"];
