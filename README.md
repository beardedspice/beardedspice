...
Download the [latest release](https://github.com/beardedspice/beardedspice/raw/releases/BeardedSpice-0.2.2.tar.gz), or find all released binaries [here](https://github.com/beardedspice/beardedspice/tree/releases).
