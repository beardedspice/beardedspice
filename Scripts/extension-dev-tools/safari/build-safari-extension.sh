...
curl https://www.apple.com/appleca/AppleIncRootCertificate.cer -OAppleIncRootCertificate.cer"
cert_exists "AppleWWDRCA.cer" "Download it from https://www.apple.com/certificateauthority/
curl http://developer.apple.com/certificationauthority/AppleWWDRCA.cer -OAppleWWDRCA.cer"
