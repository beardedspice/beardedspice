...
NSString *const BeardedSpiceSwitchTabShortcut = @"BeardedSpiceSwitchTabShortcut";
...
- (void)awakeFromNib
{
    ...
    [self.switchShortcutView setAssociatedUserDefaultsKey:BeardedSpiceSwitchTabShortcut];
}
