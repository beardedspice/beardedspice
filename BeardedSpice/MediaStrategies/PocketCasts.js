...
BSStrategy = {
  ...
  toggle: function toggle () {document.querySelector('div.play_pause_button').click()},
  next: function next () {document.querySelector('div.skip_forward_button').click()},
  previous: function previous () {document.querySelector('div.skip_back_button').click()},
  pause: function pause () {document.querySelector('div.pause_button').click()},
