...
BSStrategy = {
  ...
  favorite: function () { document.querySelector('.player-controls .d-like.player-controls__btn').click(); },
  ...
  trackInfo: function () {
    return {
      ...
      favorited: !!document.querySelector('.player-controls__track-controls .d-like.d-like_on'),
