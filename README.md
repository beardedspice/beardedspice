...
## How?
All you need to do is just open your favorite [supported media site](#supported-sites) in either Chrome or Safari, then click on BeardedSpice's Menubar icon ![BeardedSpice](images/icon20x19.svg) and select the website you want to control using your media keys.
